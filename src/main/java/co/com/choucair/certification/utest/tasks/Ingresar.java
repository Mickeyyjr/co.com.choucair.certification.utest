...
public class Ingresar implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(Click.on(By.xpath("//div[text()= '"+usuario.getPais()+"']")));
        actor.attemptsTo(Click.on(PaginaRegistro.BUTTON_NEXT));
        actor.attemptsTo(Click.on(PaginaRegistro.SELECT_YOUR_COMPUTER));
        actor.attemptsTo(Click.on(By.xpath("//div[text()= '"+usuario.getComputador()+"']")));
        actor.attemptsTo(Click.on(PaginaRegistro.SELECT_VERSION));
        actor.attemptsTo(Click.on(By.xpath("//div[text()= '"+usuario.getVersionComputador()+"']")));
        actor.attemptsTo(Click.on(PaginaRegistro.SELECT_OS_LANGUAGE));
        actor.attemptsTo(Click.on(By.xpath("//div[text()= '"+usuario.getLenguajeComputador()+"']")));
        actor.attemptsTo(Click.on(PaginaRegistro.SELECT_YOUR_MOBILE_DEVICE));
        actor.attemptsTo(Click.on(By.xpath("//div[text()= '"+usuario.getSistemaOperativoCelular()+"']")));
        actor.attemptsTo(Click.on(PaginaRegistro.SELECT_MODEL));
        actor.attemptsTo(Click.on(By.xpath("//div[text()= '"+usuario.getModeloCelular()+"']")));
        actor.attemptsTo(Click.on(PaginaRegistro.SELECT_OPERATING_SYSTEM));
        actor.attemptsTo(Click.on(By.xpath("//div[text()= '"+usuario.getVersionSistemaOperativo()+"']")));
        actor.attemptsTo(Click.on(PaginaRegistro.BUTTON_NEXT));
